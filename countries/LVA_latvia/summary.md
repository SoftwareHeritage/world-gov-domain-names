...
| 6 | `roc-taiwan.org` | wikidata;wikidata | Taipei Mission in the Republic of Latvia | Taipei Mission in Latvia |
| 4 | `archiv.org.lv` | wikidata | Latvian State Archive |
| 4 | `bank.lv` | wikidata | Bank of Latvia |
| 4 | `cvk.lv` | wikidata | Central Election Commission |
...
| 4 | `mofaic.gov.ae` | wikidata | Embassy of the United Arab Emirates, Riga |
...
| score | hostname | sources | label |
|------:|----------|---------|-------|
| 4 | `adazi.lv` | wikidata | Q90307473 |
| 4 | `cesis.lv` | wikidata | Q90309861 |

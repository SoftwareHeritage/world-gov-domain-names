...
- Capital: Mogadishu
- Domains collected (HTTP 200): 662

## UN/DESA national portal

- Declared: [https://opm.gov.so](https://opm.gov.so) (host `opm.gov.so`)
...
- Highest courts: the provisional constitution stipulates the establishment of the Constitutional Court (consists of 5 judges, including the chief judge and deputy chief judge)

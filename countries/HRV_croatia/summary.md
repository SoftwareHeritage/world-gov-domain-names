...
| 7 | `minfin.hr` | central | wikidata;wikidata | Ministry of Finance of the Republic of Croatia |
| 7 | `mint.hr` | central | wikidata;wikidata | Ministry of Tourism and Sports |
| 7 | `mmpi.hr` | central | wikidata;wikidata | Ministry of Maritime Affairs, Transport and Infrastructure |
| 7 | `morh.hr` | central | wikidata;wikidata | Ministry of Defence |
| 7 | `mps.hr` | central | wikidata;wikidata | Ministry of Agriculture of Croatia |
| 7 | `mrms.hr` | central | wikidata;wikidata | Ministry of Labour and Pension System (Croatia) |
| 7 | `mup.hr` | central | wikidata;wikidata | Ministry of the Interior of Croatia |
...
| 7 | `public.mzos.hr` | central | wikidata;wikidata | Ministry of Science and Education |
| 7 | `sabor.hr` | central | wikidata;wikidata | Parliament of Croatia |
| 7 | `soa.hr` | central | wikidata;wikidata | Security and Intelligence Agency | Military Security and Intelligence Agency |

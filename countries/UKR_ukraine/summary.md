...
- Declared: [http://www.kmu.gov.ua](http://www.kmu.gov.ua) (host `kmu.gov.ua`)
...
284 domain(s) proposed for validation, of which 6 at the first subdivision level (`central-1`: Land, state, region…). Full list in [`proposed.csv`](proposed.csv).

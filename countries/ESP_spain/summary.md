...
|------:|----------|-------|------|---------|-------|
| 10 | `aemet.es` |  | HttpConne... | wikidata;linkgraph | Agencia Estatal de Meteorología |
| 10 | `aepd.es` | central | 301 | wikidata;linkgraph | Spanish Data Protection Agency |
| 10 | `asturias.es` | central-1 | SSLHandsh... | wikidata;wikidata;wikidata;linkgraph | Government of the Principality of Asturias | Q9076467 |
| 10 | `boe.es` |  | HttpConne... | wikidata;linkgraph | State Agency for the Official State Gazette |
| 10 | `carm.es` | central-1 | SSLHandsh... | wikidata;wikidata;linkgraph | Council of Government of the Region of Murcia |
| 10 | `castillalamancha.es` | central-1 | 200 | wikidata;wikidata;wikidata;linkgraph | Regional Government of Castilla–La Mancha | Regional Government of Castile-La... |
| 10 | `comunidad.madrid` | central-1 | 301 | wikidata;wikidata;linkgraph | Community of Madrid Fire Department | Instituto Madrileño de Investigación y ... |
...
| 10 | `ordenacionjuego.es` | central | SSLHandsh... | wikidata;wikidata;linkgraph | Dirección General de Ordenación del Juego |

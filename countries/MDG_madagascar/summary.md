...
- Domains collected (HTTP 200): 504

## UN/DESA national portal

- Declared: [http://www.presidence.gov.mg](http://www.presidence.gov.mg) (host `presidence.gov.mg`)
...
| 4 | `assemblee-nationale.mg` | wikidata | National Assembly |
...
| 3 | `eeas.europa.eu` | wikidata | Delegation of the European Union to Madagascar and to the Comoros |
| 3 | `madagascar.mid.ru` | wikidata | embassy of Russia in Madagascar |
| 3 | `mg.ambafrance.org` | wikidata | Embassy of France, Antananarivo |

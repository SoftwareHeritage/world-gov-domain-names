...
- Capital: Jakarta
- Hosts collected: 2582

## UN/DESA national portal

- Declared: [http://indonesia.go.id](http://indonesia.go.id) (host `indonesia.go.id`)
- ⚠️ Exact hostname not collected, but `go.id` is harvested (to be probed)

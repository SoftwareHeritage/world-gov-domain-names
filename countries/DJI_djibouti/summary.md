...
- ⚠️ ABSENT -- neither `presidence.dj` covered nor `countries/DJI_djibouti/sources/presidence.dj/` directory present

## Institutions named by CIA Factbook

- Chief of state: President Ismail Omar GUELLEH (since 8 May 1999)
- Head of government: Prime Minister Abdoulkader Kamil MOHAMED (since 1 April 2013)
- Highest courts: Supreme Court or Cour Suprême (consists of NA magistrates); Constitutional Council (consists of 6 magistrates)

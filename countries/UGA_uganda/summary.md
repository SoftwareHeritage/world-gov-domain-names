...
|------:|----------|-------|------|---------|-------|
| 7 | `agriculture.go.ug` | central | 301 | wikidata;wikidata | Ministry of Agriculture, Animal Industry and Fisheries |
| 7 | `education.go.ug` | central | 301 | wikidata;wikidata | Ministry of Education and Sports |
| 7 | `energyandminerals.go.ug` | central | ConnectEx... | wikidata;wikidata | Ministry of Energy and Mineral Development |
| 7 | `finance.go.ug` | central | 200 | wikidata;wikidata | Ministry of Finance, Planning and Economic Development |
| 7 | `health.go.ug` | central | SSLHandsh... | wikidata;wikidata | Ministry of Health |
| 7 | `ict.go.ug` | central | 200 | wikidata;wikidata | Ministry of Information and Communications Technology |
| 7 | `mia.go.ug` | central | 200 | wikidata;wikidata | Ministry of Internal Affairs |
| 7 | `mlhud.go.ug` | central | 200 | wikidata;wikidata | Ministry of Lands, Housing and Urban Development |
| 7 | `mofa.go.ug` | central | 200 | wikidata;wikidata | Ministry of Foreign Affairs of the Republic of Uganda |
| 7 | `mtic.go.ug` |  | 301 | wikidata;wikidata | Ministry of Trade, Industry and Cooperatives |
| 7 | `mtti.go.ug` | central | ConnectEx... | wikidata;wikidata | Ministry of Trade, Tourism and Industry |
| 7 | `mwe.go.ug` | central | 200 | wikidata;wikidata | Ministry of Water and Environment |

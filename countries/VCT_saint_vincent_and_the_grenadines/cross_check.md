# Cross-check: VCT_saint_vincent_and_the_grenadines

## Overview

- UN status: **Member State**
- ccTLD: `.vc` (manager: Ministry of Telecommunications)
- OECD: non-member
- UN/DESA EGDI: Rank 117 of 193
- Government type: parliamentary democracy under a constitutional monarchy; a Commonwealth realm
- Capital: Kingstown
- Domains collected (HTTP 200): 32

## UN/DESA national portal

- Declared: [http://www.gov.vc](http://www.gov.vc) (host `gov.vc`)

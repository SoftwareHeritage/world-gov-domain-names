...
| 7 | `justice.ir` | central | SSLHandsh... | wikidata;wikidata | Ministry of Justice (Iran) |
| 7 | `maj.ir` | central | SSLHandsh... | wikidata;wikidata | Ministry of Agriculture Jihad |
| 7 | `mcth.ir` | central | HttpConne... | wikidata;wikidata | Ministry of Cultural Heritage, Tourism and Handicrafts |
| 7 | `medu.ir` | central | ConnectEx... | wikidata;wikidata | Ministry of Education of Iran |
| 7 | `mefa.ir` | central | 301 | wikidata;wikidata | Ministry of Economic Affairs and Finance (Iran) |
| 7 | `mod.ir` | central | ConnectEx... | wikidata;wikidata | Ministry of Defense and Armed Forces Logistics |
| 7 | `moi.ir` | central | 403 | wikidata;wikidata | Ministry of Interior (Iran) |
| 7 | `mop.ir` | central | 403 | wikidata;wikidata | Ministry of Petroleum |
| 7 | `mrt.ir` | central | HttpConne... | wikidata;wikidata | Ministry of Roads and Transportation |
| 7 | `mrud.ir` | central | HttpConne... | wikidata;wikidata | Ministry of Roads and Urban Development |
| 7 | `police.ir` |  | HttpConne... | wikidata;wikidata | Police Command of the Islamic Republic of Iran | Guidance Patrol |
| 7 | `rc.majlis.ir` | central | 200 | wikidata;wikidata | Islamic Consultative Assembly |

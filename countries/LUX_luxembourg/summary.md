...
| 3 | `ambruslu.mid.ru` | central | wikidata | Embassy of Russia in Luxembourg |
| 3 | `lu.china-embassy.org` | central | wikidata | Embassy of the People's Republic of China, Luxembourg City |
| 3 | `luxembourg.europarl.europa.eu` | central | wikidata | European Parliament Liaison Office in Luxembourg |
| 3 | `luxembourg.mae.ro` | central | wikidata | Embassy of Romania, Luxembourg |
| 3 | `luxembourg.representation.ec.europa.eu` |  | wikidata | European Commission Representation in Luxembourg |
| 3 | `luxemburg.diplo.de` | central | wikidata | Embassy of Germany, Luxembourg |
| 3 | `luxemburgo.embaixadaportugal.mne.pt` | central | wikidata | Embassy of Portugal in Luxembourg |
| 3 | `mzv.cz` | central | wikidata | Embassy of the Czech Republic in Luxembourg |

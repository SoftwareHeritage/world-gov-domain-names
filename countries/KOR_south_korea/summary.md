...
- Declared: [https://www.gov.kr](https://www.gov.kr) (host `gov.kr`)
...
483 domain(s) proposed for validation, of which 11 at the first subdivision level (`central-1`: Land, state, region…). Full list in [`proposed.csv`](proposed.csv).
Top 20 by score (0-10) -- higher = stronger cross-source evidence:

| score | hostname | level | http | sources | label |
|------:|----------|-------|------|---------|-------|
| 7 | `cbnuh.or.kr` |  | ConnectEx... | wikidata;wikidata | Chungbuk National University Hospital |
| 7 | `cnuh.co.kr` |  | 403 | wikidata;wikidata | Chungnam National University Hospital |
| 7 | `council.chungbuk.kr` | central-1 | HttpTimeo... | wikidata;wikidata | North Chungcheong Province municipal council |
| 7 | `council.gangwon.kr` | central-1 | 403 | wikidata;wikidata | Gangwon State Council |
...
| 7 | `gncl.or.kr` | central-1 | ConnectEx... | wikidata;wikidata | South Gyeongsang Province municipal council |
| 7 | `gnuh.co.kr` |  | SSLHandsh... | wikidata;wikidata | Gyeongsang National University Hospital |
| 7 | `grac.or.kr` |  | 200 | wikidata;wikidata | Game Rating and Administration Committee |

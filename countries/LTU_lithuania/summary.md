...
- Declared: [https://lrv.lt](https://lrv.lt) (host `lrv.lt`)
...
| 5 | `stat.gov.lt` | wikidata | State Data Agency of Lithuania |
| 5 | `strata.gov.lt` | wikidata | Government Strategic Analysis Center |
| 4 | `ada.lt` | wikidata | State Data Protection Inspectorate |
...
| score | hostname | sources | label |
|------:|----------|---------|-------|
| 7 | `vilnius.lt` | wikidata;wikidata | Vilnius City Municipality Administration |

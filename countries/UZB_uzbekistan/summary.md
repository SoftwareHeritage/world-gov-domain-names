...
|------:|----------|-------|------|---------|-------|
| 7 | `iiv.uz` | central | ConnectEx... | wikidata;wikidata | Ministry of Internal Affairs |
| 7 | `joqargikenes.uz` |  | 302 | wikidata;wikidata | Supreme Council of Karakalpakstan |
| 7 | `mc.uz` | central | 301 | wikidata;wikidata | Ministry of Construction of the Republic of Uzbekistan |
| 7 | `mdo.uz` | central | HttpConne... | wikidata;wikidata | Ministry of Preschool Education of the Republic of Uzbekistan |
| 7 | `mehnat.uz` | central | 301 | wikidata;wikidata | Ministry of Labor and Social Protection of Population |
| 7 | `mfa.uz` | central | 301 | wikidata;wikidata | Ministry of Foreign Affairs of Uzbekistan |
| 7 | `minjust.uz` | central | 301 | wikidata;wikidata | Ministry of Justice |

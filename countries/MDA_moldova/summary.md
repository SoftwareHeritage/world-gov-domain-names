...
| 4 | `chisinau.mfa.gov.hu` | wikidata | Embassy of Hungary, Chișinău |
| 4 | `cnh.prm.md` | wikidata | National Heraldry Commission |
| 4 | `constcourt.md` | wikidata;wikidata;wikidata | Constitutional Court of Moldova |
...
6 candidate(s) attributed to a non-central administration (out of the registry's central-gov scope), of which 3 at the first subdivision level (`central-1`: Land, state, region…). Full list in [`candidates-local.csv`](candidates-local.csv). Top 10:
...
| 4 | `usarb.md` | wikidata | Alecu Russo State University of Bălți |
| 4 | `usm.md` | wikidata | Moldova State University |

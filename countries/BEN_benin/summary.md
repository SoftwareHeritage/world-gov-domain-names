...
- Domains collected (HTTP 200): 421

## UN/DESA national portal

- Declared: [http://gouv.bj](http://gouv.bj) (host `gouv.bj`)
...
| 7 | `finances.bj` | wikidata;wikidata | Ministry of Economy and Finance |
| 6 | `misiones.cubaminrex.cu` | wikidata;wikidata | embassy of Cuba in Benin |
| 5 | `cour-constitutionnelle-benin.org` | wikidata | Constitutional Court of Benin |
